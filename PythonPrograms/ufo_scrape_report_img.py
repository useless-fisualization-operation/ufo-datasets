...
Scrapes data from the NUFORC website
A more thorough scraper than ufo_scrape.py.
Added is the possibility of scraping images and 
entire summary of the ufo reports.
