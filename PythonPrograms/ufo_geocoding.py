...
Find the coordinates for the ufo sightings 
based on city and state name. It is a very 
slow program due to the limitations posed 
by the geocoder service Nominatim.
